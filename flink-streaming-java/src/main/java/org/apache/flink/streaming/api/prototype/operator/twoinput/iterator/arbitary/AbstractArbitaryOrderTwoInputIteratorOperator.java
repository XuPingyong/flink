...
public abstract class AbstractArbitaryOrderTwoInputIteratorOperator<OUT>
		...
		implements ArbitaryOrderTwoInputIteratorOperator
{
	...
	public ControlElementProcessor getControlElementProcessor1() {
		return new ControlElementProcessor() {
			...
			public Processor<Watermark> getWatermarkProcessor() throws Exception {
				return AbstractArbitaryOrderTwoInputIteratorOperator.this.getWatermarkProcessor1();
			}

			@Override
			public Processor<LatencyMarker> getLatencyMarkerProcessor() throws Exception {
				return AbstractArbitaryOrderTwoInputIteratorOperator.this.getLatencyMarkerProcessor1();
			}
		};
	}
	...
	public ControlElementProcessor getControlElementProcessor2() {
		return new ControlElementProcessor() {
			...
			@Override
			public Processor<Watermark> getWatermarkProcessor() throws Exception {
				return AbstractArbitaryOrderTwoInputIteratorOperator.this.getWatermarkProcessor2();
			}

			@Override
			public Processor<LatencyMarker> getLatencyMarkerProcessor() throws Exception {
				return AbstractArbitaryOrderTwoInputIteratorOperator.this.getLatencyMarkerProcessor2();
			}
		};
	}
