...
import org.apache.flink.streaming.api.prototype.operator.twoinput.iterator.fixed.TwoInputIteratorOperator;
...
public abstract class AbstractArbitaryOrderTwoInputElementIteratorOperator<IN1, IN2, OUT>
		...
		implements TwoInputIteratorOperator
{
	...
	public void run(MutableObjectIterator<DataInputView> input1, MutableObjectIterator<DataInputView> input2) {
		runWithElement(new MutableObjectIterator<IN1>() {
	...
	public abstract void runWithElement(MutableObjectIterator<IN1> input1, MutableObjectIterator<IN2> input2);
	...
	public ControlElementProcessor getControlElementProcessor1() {
		return new ControlElementProcessor() {
			...
			public Processor<Watermark> getWatermarkProcessor() throws Exception {
				return AbstractArbitaryOrderTwoInputElementIteratorOperator.this.getWatermarkProcessor1();
			}

			@Override
			public Processor<LatencyMarker> getLatencyMarkerProcessor() throws Exception {
				return AbstractArbitaryOrderTwoInputElementIteratorOperator.this.getLatencyMarkerProcessor1();
			}
		};
	}
	...
	public ControlElementProcessor getControlElementProcessor2() {
		return new ControlElementProcessor() {
			...
			@Override
			public Processor<Watermark> getWatermarkProcessor() throws Exception {
				return AbstractArbitaryOrderTwoInputElementIteratorOperator.this.getWatermarkProcessor2();
			}

			@Override
			public Processor<LatencyMarker> getLatencyMarkerProcessor() throws Exception {
				return AbstractArbitaryOrderTwoInputElementIteratorOperator.this.getLatencyMarkerProcessor2();
			}
		};
	}
